...
- [대화형 콘텐츠](https://developer.mozilla.org/ko/docs/Web/Guide/HTML/Content_categories#%EB%8C%80%ED%99%94%ED%98%95_%EC%BD%98%ED%85%90%EC%B8%A0 "대화형 콘텐츠")는 기본적으로 tabindex="0"
- tabindex 값이 같은 경우 html에 작성된 순서대로 이동
- 비대화형 콘텐츠에도 tabindex를 적용시켜 탭 순서 적용가능
- tabindex가 양수의 순서대로 이동하고 0으로 이동
- tabindex="-1" 일 경우 포커스는 가능하지만 탭 순서에서 제외
- tabindex="1" 이상의 양수값은 논리적 흐름을 방해하기 때문에 사용을 추천하지 않음
- [tabindex mdn](https://developer.mozilla.org/ko/docs/Web/HTML/Global_attributes/tabindex "tabindex mdn")
